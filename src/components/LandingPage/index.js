  ...
  return (
    <>
      ...
      >
        ...
        <div
          className='bg-white xl:bg-[#F0F0F0] rounded-none xl:rounded-[31.5px] flex flex-col xl:flex-row justify-normal items-center xl:justify-between gap-[29px] mt-[145px] md:mt-[65px] xl:mt-[180
